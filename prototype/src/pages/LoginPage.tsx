...
export function LoginPage() {
  ...
  const [email, setEmail] = useState('anna@wishly.ru');
  ...
  return (
    <div>
      ...
      <div className="mt-8 rounded-xl border border-dashed border-teal-200 bg-teal-50/50 p-4">
        ...
        <p className="mt-3 text-xs text-slate-500">Любой неизвестный email + пароль ≥ 4 символов тоже войдёт (как гость-booker).</p>
      </div>
    </div>
  );
}
